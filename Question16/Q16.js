var initial_GuestList = ["Farkhanda", "Fatima", "Ramla", "Alitha", "Aruj", "Aneesa"];
...
initial_GuestList.forEach(function (guest) {
    console.log("Dear ".concat(guest, ", you are invited to dinner. Please join us at 8:00 on Monday."));
});
